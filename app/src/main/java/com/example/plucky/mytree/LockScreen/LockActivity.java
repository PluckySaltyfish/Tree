...
public class LockActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Integer.parseInt(f)==1){
            ...
            StartService(flag, Integer.parseInt(hoursTv.getText().toString()), Integer.parseInt(minutesTv.getText().toString()), Integer.parseInt(secondsTv.getText().toString()),1,0);
            ...
            flag=0;
            StartService(flag, Integer.parseInt(hoursTv.getText().toString()), Integer.parseInt(minutesTv.getText().toString()), Integer.parseInt(secondsTv.getText().toString()),0,0);
        }
        ...
        pause.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                if(hour==0&&minute==0&&second==0) {
                    ...
                    flag=0;
                    StartService(flag, Integer.parseInt(hoursTv.getText().toString()), Integer.parseInt(minutesTv.getText().toString()), Integer.parseInt(secondsTv.getText().toString()),0,1);
                    mRemoteData.setTimes(taskID);
                    finish();
    ...
    public void StartService(int fl,int countdatahour,int countdataminute,int countdatasecond,int flagisone,int fuck){
